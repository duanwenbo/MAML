...
if __name__ == "__main__":
    level_name = 'alchemy/perceptual_mapping_randomized_with_rotation_and_random_bottleneck'
    env = symbolic_alchemy.get_symbolic_alchemy_level(level_name, seed=131)
    env.reset()
    print(env._chemistry.potion_map)
    print(env._chemistry.potion_map)
    env.reset()
    print(env._chemistry.potion_map)
    print(env._chemistry.potion_map)
    ...
    print("#######################################################")
    # timestep = env.reset()
    # print(env._chemistry_gen().potion_map)
    # print("#######################################################")
    # timestep = env.reset()
    # print(env._chemistry_gen().potion_map)
    # print("#######################################################")
    # print(timestep.observation["symbolic_obs"])
    # print("#######################################################")
    # timestep = env.reset()
    # print(timestep.observation["symbolic_obs"])
